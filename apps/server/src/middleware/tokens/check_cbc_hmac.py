...
from src.lib.tokens.cbc_hmac import check_cbc_hmac_lib, check_cbc_hmac_with_us
from src.models.token import CheckTokenReturnT, CheckTokenWithUsReturnT, TokenT
...
def check_cbc_hmac_with_us_mdw(
    token_t: TokenT,
